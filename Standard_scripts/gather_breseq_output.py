...
input_folder = Path("/mnt/sysbio/PAULSSON LAB/Personal_Folders/Antoine/Genomics/Raw_sequencing_data/Replication_dynamics/Breseq_output")
output_folder = Path("/home/antoine/Documents/Travel/Genomics/Replication_dynamics/Gathered_Breseq_data")
...
def get_file_mapping(name):
    return [
        ...
        (input_folder / name / "08_mutation_identification/U00096.coverage.tab", 
         output_folder / "Coverage" / f"{name.name}.coverage.tab")
    ]
